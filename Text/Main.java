...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            int count = 1;
            br = new BufferedReader(new FileReader(new File("src\\main\\java\\Text\\input.txt")));  //src\input.txt
            PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter("src\\\\main\\java\\Text\\output.txt", true))); 
            String line;
